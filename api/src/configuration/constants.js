...
if (!process.env.PORT || !process.env.OPEN_API_KEY || !process.env.FIREBASE_KEY_ID || !process.env.FIREBASE_KEY) {
...
export { PORT, OPEN_API_KEY, FIREBASE_KEY_ID, FIREBASE_KEY };
